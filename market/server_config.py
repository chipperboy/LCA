...
DEFAULT_MARKET_AUTH_SERVER_URL = os.getenv("AUTH_SERVER_URL", "https://www.jw3.top:8000").strip() or "https://www.jw3.top:8000"
DEFAULT_MARKET_VERIFY_SSL: Union[str, bool] = os.getenv("MARKET_VERIFY_SSL", "certs/server.pem").strip() or "certs/server.pem"
