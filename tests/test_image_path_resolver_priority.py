...
class ImagePathResolverPriorityTests(unittest.TestCase):
    ...
    def test_frozen_runtime_prefers_app_images_over_legacy_user_images(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(os.path.normcase(os.path.abspath(resolved)), os.path.normcase(str(app_image)))
